...
export default function Tos() {
  return (
    <div className="my-5 px-10 md:px-40 lg:px-96">
      <span className="text-3xl md:text-4xl font-medium">Terms of Service</span>
      <p className="mb-5 mt-2"></p>
      <span className="text-xl md:text-2xl font-medium uppercase">
        Overview
      </span>
      <p className="mb-2 mt-2">
        This website is operated by mimiblooms. Throughout the site, the terms
        “we”, “us” and “our” refer to mimiblooms. mimiblooms offers this
      ...
      are subject to return or exchange only according to our Return Policy. To
      view our Return Policy, please visit{" "}
      <a href="https://mimiblooms.store/au/privacy/">
        https://mimiblooms.store/au/privacy/
      </a>
      <p className="mb-2 mt-2">
      ...
      <p className="mb-2 mt-2">
        ...
        shall mimiblooms, our directors, officers, employees, affiliates,
      ...
      <p className="mb-2 mt-2">
        You agree to indemnify, defend and hold harmless mimiblooms and our
      ...
      <p className="mb-2 mt-2">
        ...
        cease using our site. If in our sole judgment you fail, or we suspect
        that you have failed, to comply with any term or provision of these
        Terms of Service, we also may terminate this agreement at any time
